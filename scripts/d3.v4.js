  ...
  var wv,
    ...
    Ev = function (t, n) {
      ...
      return o === u
        ...
        : "0." + new Array(1 - o).join("0") + Tv(t, Math.max(0, n + o - 1))[0];
    },
    Av = function (t, n) {
      var e = Tv(t, n);
      if (!e) return t + "";
    ...
    bm = function () {
      ...
      function l() {
        if (y.apply(this, arguments)) {
          ...
          xm(),
            N > 0
              ? by(this).transition().duration(N).call(u, f, a)
      ...
      function h() {
        if (y.apply(this, arguments)) {
          ...
          for (oa(), e = 0; e < c; ++e)
            (r = u[e]),
              (i = My(this, u, r.identifier)),
              (i = [i, this.__zoom.invert(i), r.identifier]),
              o.touch0
                ? o.touch1 || (o.touch1 = i)
                : ((o.touch0 = i), (n = !0));
          return v && ((v = clearTimeout(v)), !o.touch1)
            ? (o.end(),
              (i = by(this).on("dblclick.zoom")),
